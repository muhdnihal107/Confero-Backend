...
from .views import RegisterView, LoginView,ProfileView,VerifyEmailView,ForgotPasswordView,ResetPasswordView,google_login,FetchAllProflieView,ValidateTokenView,FriendRequestView,FriendRequestActionView, UserListView,UserDetailView
