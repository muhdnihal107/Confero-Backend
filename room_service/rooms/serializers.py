...
class RoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Room
        fields = ['id', 'name', 'slug', 'description', 'visibility', 'creator_id', 'creator_email', 'invited_users', 'created_at', 'updated_at']
...
class PublicRoomSerializer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['id', 'name', 'slug', 'description', 'creator_email', 'created_at']
