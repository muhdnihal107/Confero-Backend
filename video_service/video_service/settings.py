...
SECRET_KEY = 'django-insecure-*wdk4+qv1g^i&gdh*%oup*u73qhajh8+l9*ksbmiq87%^53zx)'
...
ASGI_APPLICATION = 'video_service.asgi.application'  # Match your package name
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'call.authentication.http_auth.CustomJWTAuthentication',
    ],
}
